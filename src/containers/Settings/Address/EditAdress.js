      ...
      <div className="w-full lg:w-[38vw] mt-10">
        ...
        <div className="grid grid-cols-2 gap-x-5">
          <Input
            ...
            type={"text"}
            title={"Country"}
            requiredtitle={country ? "text-black" : "text-logoColor"}
            className="p-2"
            onChange={onChangeHandler}
          />
          <Input
            ...
            type={"tel"}
            title={"Phone number"}
            requiredtitle={phone_number ? "text-black" : "text-logoColor"}
            className="p-2"
            onChange={onChangeHandler}
          />
        </div>
        ...
        />
        <CheckBox
          title={"Default (Standard) billing"}
          className="w-5 h-5"
          titleClassName="font-normal"
          containerStyle="my-5"
        />
        <CheckBox
          title={"Default (Standard) shipping"}
          className="w-5 h-5"
          titleClassName="font-normal"
          containerStyle="my-5"
        />
