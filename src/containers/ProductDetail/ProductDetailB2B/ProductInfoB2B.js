      ...
      <ProductDetail>
        ...
        <ProductPrice>
          <div className="flex flex-col">
            <BasicBold className={"xl:text-lg lg:text-base text-sm"}>{productPrice}</BasicBold>
        ...
        <ProductExpiry>
          <span>Private</span>
          <BasicBold className={"xl:text-lg lg:text-base text-sm"}>{privateRate}</BasicBold>

          <span>Gastronomy</span>
          <BasicBold className={"xl:text-lg lg:text-base text-sm"}>{gastranomyRate}</BasicBold>
        </ProductExpiry>
      </ProductDetail>
    </Container>
  );
